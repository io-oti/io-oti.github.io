        ...
        items: [
          {
            text: "Vue 3",
            items: [
              { text: "Options API", link: "posts/vue/3/options-api" },
              { text: "Composition API", link: "posts/vue/3/composition-api" },
            ],
          },
          {
            text: "Vue 2",
            items: [
              ...
              { text: "渲染函数", link: "posts/vue/2/render-function" },
              { text: "JSX", link: "posts/vue/2/jsx" },
            ],
          },
          {
            text: "Vite",
